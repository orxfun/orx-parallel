...
impl Factors for Method {
    ...
    fn factor_levels(&self) -> Vec<String> { vec![match self { Self::Seq => "seq", Self::Rayon => "rayon", Self::OrxOnce => "orx-once", Self::OrxBasic => "orx-basic", Self::OrxRayon => "orx-rayon" }.to_string()] }
}
