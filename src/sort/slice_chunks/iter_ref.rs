...
pub struct SliceIterVal<'a, T: 'a> {
    data: *const T,
    exclusive_end: *const T,
    phantom: PhantomData<&'a ()>,
}

impl<T> Default for SliceIterVal<'_, T> {
    fn default() -> Self {
        Self {
            data: core::ptr::null(),
...
impl<'a, T: 'a> Iterator for SliceIterVal<'a, T> {
    type Item = &'a T;
...
impl<'a, T: 'a> ExactSizeIterator for SliceIterVal<'a, T> {
    fn len(&self) -> usize {
