...
/// Sequential iterator for a two-stage optional `XapUse` pipeline.
#[must_use = "iterators are lazy and do nothing unless consumed"]
pub struct XapUseOptionIter<U, I, M, X1, X2, S>
where
    U: Use,
    I: Iterator,
    ...
    S: SizePair<S1 = X1::Size, S2 = X2::Size>,
{
    ...
    x1: X1,
    x2: X2,
    values: Option<<S::XapUseOptResult<M, X1, X2> as IntoIterator>::IntoIter>,
    use_ptr: *mut U::Item,
}

impl<U, I, M, X1, X2, S> XapUseOptionIter<U, I, M, X1, X2, S>
where
    U: Use,
    I: Iterator,
    X1: XapUse<U = U::Item, I = I::Item, O = Option<M>>,
...
impl<U, I, M, X1, X2, S> Iterator for XapUseOptionIter<U, I, M, X1, X2, S>
where
    U: Use,
    I: Iterator,
    X1: XapUse<U = U::Item, I = I::Item, O = Option<M>>,
    ...
    S: SizePair<S1 = X1::Size, S2 = X2::Size>,
{
    ...
    fn next(&mut self) -> Option<Self::Item> {
        loop {
            ...
            self.values = Some(S::xap_use_opt(self.use_ptr, self.x1, self.x2, input).into_iter());
        }
    }
        ...
        F: FnMut(B, Self::Item) -> B,
    {
        ...
        for input in self.iter {
            result = S::xap_use_opt(self.use_ptr, self.x1, self.x2, input)
                .into_iter()
                .fold(result, &mut f);
        }
        result
