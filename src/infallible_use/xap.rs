...
pub trait XapUse: Copy + Send {
    ...
    {
        <Self::Size as Size>::u_map(self, h)
    }
    ...
    {
        <Self::Size as Size>::u_inspect(self, h)
    }
    ...
    {
        <Self::Size as Size>::u_filter(self, h)
    }
    ...
    {
        <Self::Size as Size>::u_filter_map(self, h)
    }
    ...
    where
        M: UMap<U = Self::U, I = Self::O>,
    {
        <Self::Size as Size>::u_mapped(self, m)
    }
}
...
pub type MapOf<X, Q, H> = <<X as XapUse>::Size as Size>::UMap<X, Q, H>;

pub type InsOf<X, H> = <<X as XapUse>::Size as Size>::UInspect<X, H>;

pub type FilOf<X, H> = <<X as XapUse>::Size as Size>::UFilter<X, H>;

pub type FilMapOf<X, Q, H> = <<X as XapUse>::Size as Size>::UFilterMap<X, Q, H>;
