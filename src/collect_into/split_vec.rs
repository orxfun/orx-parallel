...
use crate::computational_variants::computations::{collect_into, try_collect_into};
    ...
    Self: PseudoDefault,
{
        ...
        X1: Fn(I::Item) -> Vo + Sync,
    {
        ...
        let (_num_spawned, pinned_vec) = collect_into(orchestrator, params, iter, xap1, self);
        pinned_vec
    }
