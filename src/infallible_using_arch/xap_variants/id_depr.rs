...
pub struct IdDepr<U, I>(PhantomData<(U, I)>);

impl<U, I> Clone for IdDepr<U, I> {
    fn clone(&self) -> Self {
        Self::new()
    }
}

impl<U, I> Copy for IdDepr<U, I> {}

unsafe impl<U, I> Send for IdDepr<U, I> {}
