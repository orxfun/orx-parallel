use crate::infallible_arch::count::iter::{FilterMapIterMany, FlatMapIterMany};
use crate::infallible_arch::count::{Count, iter::MapIterMany};
use crate::infallible_arch::fun::{filter_map::FilterMap, flat_map::FlatMap, map::Map};
