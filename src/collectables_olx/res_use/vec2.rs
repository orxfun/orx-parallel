use crate::Vec2;
use crate::collectables_old::alg::merge_collected::merge_ord_into_vec;
use crate::collectables_old::res_use::ColIntoResUse;
...
impl<T: Send> ColIntoResUse<T> for Vec2<T> {
