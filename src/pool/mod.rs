...
compile_error!(
    "Features 'wasm-web-threads' and 'wasm-web-threads-experimental' are mutually exclusive on wasm32; enable only one wasm backend feature."
);
...
#[cfg(all(feature = "std", feature = "wasm-web-threads-experimental", target_arch = "wasm32"))]
pub type DefaultPool = pool_impl::WasmWebPoolExp;
#[cfg(all(
    feature = "std",
    feature = "wasm-web-threads",
    target_arch = "wasm32",
    not(feature = "wasm-web-threads-experimental")
))]
...
#[cfg(all(
    ...
    not(any(
        ...
        all(feature = "wasm-web-threads-experimental", target_arch = "wasm32")
    ))
))]
